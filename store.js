...
(function(){
  ...
  function renderCats(){
    ...
    document.querySelectorAll("#catNav [data-cat],#mobileCats [data-cat]").forEach(function(b){b.addEventListener("click",function(){var c=b.dataset.cat;if(c==="Services"){goSection("how");return;}activeCat=c;renderCats();renderProducts();if(window.innerWidth<=900)$("mobileCats").classList.remove("open");});});
